...
所以，在每一次报告问题时，<mark>不要只丢下一句「解析报错」等就跑了。在没有日志、报错截图等信息的辅助下，我们 **不可能** 知道网线对面的你到底遇到了什么问题。</mark>
...
* 在问题发生之前，你分别都进行了哪些操作？
---
* <Badge type="info" text="控制台" /> 你正在使用什么版本的 ESX、QB……？你的操作系统是什么？网络环境是什么？
* <Badge type="info" text="核心" /> 你使用的是哪个核心？是否已经更新到最新版本？
