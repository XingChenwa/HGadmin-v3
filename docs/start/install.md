...
```sh [GitHub]
git clone --depth=1 https://github.com/XingChenwa/HGadmin-v3.git ./plugins/kkkkkk-10086/
```

```sh [Ghproxy]
git clone --depth=1 https://ghp.ci/https://github.com/XingChenwa/HGadmin-v3.git ./plugins/kkkkkk-10086/
```
...
```sh [GitHub]
git clone --depth=1 https://github.com/XingChenwa/HGadmin-v3.git ./plugins/karin-plugin-kkkkkk-10086/
```

```sh [Ghproxy]
git clone --depth=1 https://ghp.ci/https://github.com/XingChenwa/HGadmin-v3.git ./plugins/karin-plugin-kkkkkk-10086/
```
...
1. 打开 Release 页面: https://github.com/XingChenwa/HGadmin-v3/releases
